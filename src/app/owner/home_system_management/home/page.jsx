...
const Page = () => {
  ...
  const [selectOption, setSelectedOption] = useState("Good");
  ...
  return (
    <div className="overflow-y-auto scrollbar-hidden">
      ...
      <div className="sm:ml-64">
        <Header appear={false} title={"Home Inventory Management"} />
        <div className="p-6 bg-white">
          <div className="mx-auto bg-white">
            <div className="flex flex-col sm:flex-row gap-4 w-full pt-1 justify-end items-center">
              ...
              {/* <div className={` flex flex-row items-center`}>
                ...
                <div className="relative inline-block">
                  ...
                  {isOpen && (
                    <div className="z-10 bg-white divide-y divide-gray-100 rounded-lg shadow-sm w-[260px] absolute top-full left-0 border border-gray-200 mt-2">
                      <ul className="py-2 text-sm text-gray-700">
                        {["Good", "Upcoming Maintenance", "Urgent Repair"].map(
                          (option) => (
                            <li
                              key={option}
              ...
              {/* Add Item Button */}
              <Link
                href="/owner/home_system_management/add_home"
            ...
            {/* Table of items */}
            <div className="relative overflow-x-auto scrollbar-hidden pt-12">
                ...
                <tbody>
                  {filteredProperties.map((product, index) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4">{product.roomNo}</td>
                      <td className="px-6 py-4 flex items-center justify-center gap-1">
                        <button className="text-blue-600 hover:text-blue-800">
                          <Link
                            href={`../home_system_management/home_view/${index}`}
