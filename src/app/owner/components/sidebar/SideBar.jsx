      ...
      <ul className=" font-medium">
        ...
        <li
          className={`pb-2 text-white ${section === "Deposit"
            ? "bg-[#F6F1DE] text-black" : "hover:bg-[#F6F1DE] hover:text-black "
            }`}
        >
          <Link
            href="#"
          ...
          >
            <div className="flex flex-row pl-10 justify-center items-center">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" fill="white" stroke="white" className="size-4  ">
        ...
        >
          ...
          >
            <div className="flex flex-row pl-10 justify-center items-center">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" fill="white" stroke="white" className="size-4 ">
        ...
        >
          ...
          >
            <div className="flex flex-row pl-10 justify-center items-center">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" stroke="white" fill="white" className="size-4 ">
        ...
        >
          ...
          >
            <div className="flex flex-row pl-10 justify-center items-center">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="size-4 " fill="white" stroke="white">
        ...
        >
          ...
          >
            <div className="flex flex-row pl-10 justify-center items-center">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" fill="white" stroke="white" className="size-4 ">
        ...
        >
          ...
          >
            <div className="flex flex-row pl-10 justify-center items-center">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" className="size-4 " stroke="white" fill="white">
        ...
        >
          ...
          >
            <div className="flex flex-row pl-10 justify-center items-center">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" className="size-4 " fill="white" stroke="white">
        ...
        >
          ...
          >
            <div className="flex flex-row pl-10 justify-center items-center">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" className="size-4 " fill="white" stroke="white">
        ...
        >
          ...
          >
            <div className="flex flex-row pl-10 justify-center items-center">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="white" stroke="white" className="size-4 ">
        ...
        >
          ...
          >
            <div className="flex flex-row pl-10 justify-center items-center">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="size-4 " fill="white" stroke="white">
