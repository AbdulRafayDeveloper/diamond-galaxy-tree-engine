    ...
    <div className="h-full py-4 overflow-y-auto bg-[#22405c] scrollbar">
      <ul className=" font-medium">
        <li className="flex justify-center pb-6 flex flex-col text-white justify-center items-center">
          ...
          <p>Account Balance</p>
          <p className="text-md font-mono">${data?.accountBalance}</p>
        ...
        <Link
          ...
          className={`flex items-center  p-2 text-white group ${section === "Dashboard"
              ? "bg-[#F6F1DE] text-black"
              : "hover:bg-[#F6F1DE] hover:text-black"
            }`}
        >
          <li
            className={`pt-2 pb-2 flex items-center cursor-pointer ${section === "Dashboard"
                ? "bg-[#F6F1DE] text-black"
                : "hover:bg-[#F6F1DE] hover:text-black"
              }`}
          >
