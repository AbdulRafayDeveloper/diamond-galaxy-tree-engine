...
const Page = () => {
  ...
  const buttonRef = useRef(null); const [loading, setLoading] = useState(false);
                ...
                >
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="mb-2 relative">
                      ...
                      />
                      <button type="button" className="absolute right-3 top-1/2 transform -translate-y-1/2 fill-gray-500"
                    ...
                    <div className="relative mb-2">
                      ...
                      />
                      <button type="button" className="absolute right-3 top-1/2 transform -translate-y-1/2 fill-gray-500" 
                      onClick={()=>setShowCurrentNewPass(!showConfirmNewPass)}
                      >
                        {
                          showConfirmNewPass ? (
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" className="size-5 fill-gray-400 ">
