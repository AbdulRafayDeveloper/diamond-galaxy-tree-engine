    ...
    <div className="h-full py-4 overflow-y-auto bg-[#00288E] scrollbar-hidden">
      <ul className=" font-medium">
        <li className="flex justify-center pb-6">
          <Link href="../mortgage_lender/dashboard">
        ...
        >
          <Link
            href="/mortgage_lender/dashboard"
        ...
        <li
          className={`pb-2 pt-2 hover:bg-[#FF9100] ${section === "Gift Homeowner"
              ? "bg-[#FF9100]"
              : "hover:bg-[#FF9100]"
            }`}
        >
          <Link
            href="/mortgage_lender/gift_homeowner/homeowner"
            className={`flex items-center p-2 text-white group ${section === "Gift Homeowner"
                ? "bg-[#FF9100]"
                : "hover:bg-[#FF9100]"
              }`}
          >
        ...
        <li
          className={`pb-2 pt-2 hover:bg-[#FF9100] ${section === "Payment & Subscriptions"
              ? "bg-[#FF9100]"
              : "hover:bg-[#FF9100]"
            }`}
        >
          <a
            href="/mortgage_lender/payment_subscriptions/homeowner_detail"
            className={`flex items-center p-2 text-white group ${section === "Payment & Subscriptions"
                ? "bg-[#FF9100]"
                : "hover:bg-[#FF9100]"
              }`}
          >
      ...
      <ul className="pt-4 space-y-2 font-medium">
        <li>
          <a
            href="/mortgage_lender/profile_settings"
