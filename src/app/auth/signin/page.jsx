          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-2 grid-cols-1 min-h-screen">
            ...
            >
              <div className="absolute inset-0 flex flex-col justify-center items-center bg-black bg-opacity-40 p-2 gap-4">
                ...
                <p className="text-center text-white text-sm">
                  Multi-Level Marketing (MLM) is a business strategy where individuals earn
                  income not only through direct sales of products or services but also by
                  recruiting others to join the business. Each new recruit, known as a
                  downline, can also earn commissions by selling products and recruiting
                  others.
                </p>
                <button className="bg-[#22405c] p-2 text-white w-[200px] rounded-[50px] font-bold text-sm">
                  <Link href="/auth/signup">Register Now</Link>
            ...
            <div className="md:hidden flex flex-col justify-center items-center min-h-screen px-4 gap-4">
              <img src="/logo.jpg" alt="Diamond Galaxy Logo" className="h-24 w-auto my-2" />
              <form className="w-full max-w-md p-6 rounded-l">
                {/* Header */}
                ...
                <div className="flex justify-end mb-4">
                  <Link
                    ...
                    className="text-sm text-[#22405c] font-semibold hover:underline hover:text-[#22405c]"
                  >
                    Forgot Password?
                  </Link>
                </div>
