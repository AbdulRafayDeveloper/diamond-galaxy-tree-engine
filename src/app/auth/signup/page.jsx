    ...
    <div className="relative">
      ...
      <div className="font-calibri relative z-10">
        <div className="min-h-screen flex flex-col items-center justify-center py-6 px-4 bg-gray-100">
          <div className="grid md:grid-cols-2 items-center max-w-4xl w-full">
            {/* <button
              onClick={() => router.push("/")}
            ...
            <div style={{ backgroundImage: "url('/reg.jpg')" }} className="flex relative justify-center p-4 object-cover bg-cover h-[520px] ">
            ...
            <form
              ...
              className="max-w-md md:ml-auto w-full p-5 shadow-xl h-[520px] border border-gray-300"
            >
              <div className="p-4">
