...
import PropertyTable from "../components/propertyTable/page";
  ...
  return (
    <div className="overflow-y-auto scrollbar-hidden">
      ...
      <div className="sm:ml-64">
        <Header appear={true} title={"Dashboard"} />
        <div className=" p-6 bg-white">
          <div className="mx-auto bg-white  ">
            <div className="flex flex-row gap-4 grid-cols-1 justify-center items-center text-center">
              {cardData.map((el, id) => (
                <div key={id}>
            ...
            <PropertyTable PropertyProducts={PropertyProducts} />
