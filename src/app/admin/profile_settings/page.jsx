      ...
      <div className="lg:ml-64 md:ml-64 sm:ml-0 flex flex-col flex-grow h-screen overflow-hidden">
        ...
        <div className="container">
          <div className="flex justify-center items-center mt-5">
            <div className="p-2 rounded-xl bg-[white] shadow-xl border shadow-gray-300 p-3">
              <div className="flex flex-col items-center space-y-2">
                ...
                <div className="relative w-24 h-24">
                  ...
                  {/* Camera Icon (Overlay) */}
                  <label htmlFor="imageUpload" className="absolute bottom-0 right-0  bg-[#FF9202] border border-gray-500 p-1 rounded-full cursor-pointer">
                ...
                <form>
                  <div className="flex flex-col gap-6">
                    <div className="relative flex flex-col ">
                      <label className="text-sm font-thin italic  mb-2">Username </label>
                    ...
                    <div className="flex flex-col relative" >
                      <label className="text-sm font-thin italic mb-2">Email</label>
                      <div className="relative">
                        <input
                          placeholder="Email"
                          className="p-2 text-sm rounded-lg border border-gray-300 max-w-[600px] md:w-[460px] lg:w-[600px] pl-8"
                    ...
                    <div className="grid lg:grid-cols-2 grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="relative flex flex-col">
                        <label className="text-sm font-thin italic  mb-2">Phone No:</label>
                        <div className="relative">
                          <input
                            placeholder="Phone Number"
                            className="p-2 text-sm rounded-lg border border-gray-300 max-w-[290px] lg:w-[290px] pl-8"
                            type="number"
                            name="phoneNo"
                            value={formData.phoneNo}
                            onChange={handleChange}
                          />
                          <img src="/icons/phone.png" className="absolute left-3 top-1/2 transform -translate-y-1/2 fill-gray-300 w-4 h-3" />

                        </div>
                      </div>
                      <div className="relative flex flex-col">
                        <label className="text-sm font-thin italic  mb-2">Password</label>
                        <div className="relative">
                          <input
                    ...
                    <div className="flex flex-row justify-end gap-5 mt-4">
                      ...
                      <button className="btn bg-[#FF9202] p-2 rounded-xl w-[150px] text-white" onClick={(e) => {
